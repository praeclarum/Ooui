...
/*        
        ...
        <script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=true"></script>   or  <script type="text/javascript" src="http://maps.google.com/maps/api/js?key={APIKey}"></script>
        <script src="gmaps.js"></script> available at https://raw.githubusercontent.com/HPNeo/gmaps/master/gmaps.js
*/
namespace Ooui
{
